...
export interface IKeyValueStore<HashName extends string> extends IKeyValueStoreLight<HashName> {
...
export interface IKeyValueStoreLight<HashName extends string> {
